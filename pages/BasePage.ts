...
export abstract class BasePage {
  ...
  /**
   * The configured application base URL (from BASE_URL). Exposed on the base
   * class so page objects can reference `this.baseUrl` — the near-universal
   * convention hand-built frameworks use — without it resolving to undefined.
   */
